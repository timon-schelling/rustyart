...
fn view(app: &App, model: &Model, frame: Frame) {
    ...
    for link in model.links.iter() {
        ...
        let distance_mapped =
            map_range::<f32, f32>(distance, PARTICLE_RADIUS*4., PARTICLE_DISTANCE_MAX, 0., 1.).clamp(0., 1.);
