...
const PARTICLE_NUMBER: i32 = 2500;
const PARTICLE_SPEED: f32 = 0.5;
const PARTICLE_TARGET_RADIUS: f32 = 300.;
const PARTICLE_DISTANCE_MAX: f32 = 80.;
...
fn update(app: &App, model: &mut Model, _update: Update) {
    ...
    for particle in model.particles.iter_mut() {
        ...
        particle.position -= (particle.position - particle.target).normalize() * PARTICLE_SPEED;
    }
}
